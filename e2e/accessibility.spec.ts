...
test.describe('Accessibility', () => {
  ...
  test('should have proper heading hierarchy on archive page', async ({ page }) => {
  ...
  test('should have proper ARIA labels for interactive elements', async ({ page }) => {
    ...
    if (audioButtonCount > 0) {
      await expect(audioButtons.first()).toHaveAttribute('aria-label', 'Play audio')
    }
  })
  ...
  test('should use semantic HTML elements', async ({ page }) => {
    ...
    await expect(page.locator('main')).toBeVisible().or(page.locator('section')).toBeVisible()
