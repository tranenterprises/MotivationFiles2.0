...
describe('Date Utilities', () => {
  ...
  describe('Locale and timezone handling', () => {
    ...
    it('should handle different weekdays', () => {
      ...
      expect(result1).toMatch(/(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday)/)
      expect(result2).toMatch(/(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday)/)
    })
  })
