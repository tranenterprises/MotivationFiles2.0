...
describe('ErrorBoundary Component', () => {
  ...
  describe('Error Handling', () => {
    it('catches errors and shows default fallback', () => {
      ...
      expect(screen.getByText('We encountered an unexpected error. This doesn\'t stop your grind though.')).toBeInTheDocument()
    })
    ...
    it('displays error message in fallback', () => {
      ...
      const detailsToggle = screen.getByText('Technical Details (Click to expand)')
  ...
  describe('Default Fallback UI', () => {
    ...
    it('shows motivational message', () => {
      ...
      expect(screen.getByText(/This doesn't stop your grind though/)).toBeInTheDocument()
    })
  ...
  describe('Styling and CSS Classes', () => {
    it('applies correct styling classes to fallback UI', () => {
      ...
      const errorContainer = container.querySelector('.bg-gray-800.border.border-red-500.rounded-lg')
