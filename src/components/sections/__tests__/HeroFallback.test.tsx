...
describe('HeroFallback Component', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('renders category badge', () => {
      ...
      const visibleCategory = categoryElements.find(
  ...
  describe('Status Message', () => {
    it('renders coming soon message', () => {
      ...
      expect(
        screen.getByText(
          "We're preparing today's daily motivation with full audio experience"
        )
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Quote Structure', () => {
    it('splits quote into individual words', () => {
      ...
      const wordSpans = screen
        .getByRole('main')
        .querySelectorAll('blockquote span');
  ...
  describe('Category Badge', () => {
    it('renders category badge with correct styling', () => {
      ...
      const categoryBadge = screen
        .getByText(/motivation|wisdom|discipline|grindset|reflection/)
        .closest('div');
  ...
  describe('Bottom CTA Section', () => {
    it('renders bottom call to action', () => {
      ...
      expect(
        screen.getByText('In the meantime, enjoy this inspirational quote')
      ).toBeInTheDocument();
    });
    ...
    it('renders view archive link with arrow', () => {
      ...
      const viewArchiveLink = screen.getByRole('link', {
        name: /view archive/i,
      });
  ...
  describe('Accessibility', () => {
    it('uses semantic HTML elements', () => {
      ...
      expect(
        screen.getByRole('main').querySelector('blockquote')
      ).toBeInTheDocument();
    });
