...
describe('ArchiveLoading Component', () => {
  ...
  describe('Hero Section Loading', () => {
    ...
    it('renders title loading skeleton', () => {
      ...
      const titleSkeletons = container.querySelectorAll(
        '.animate-pulse .h-16, .animate-pulse .h-20'
      );
  ...
  describe('Category Filter Loading', () => {
    it('renders category filter loading container', () => {
      ...
      const categoryContainer = container.querySelector(
        '.bg-black\\/60.backdrop-blur-sm.border-accent\\/20'
      );
  ...
  describe('Statistics Loading', () => {
    it('renders statistics loading container', () => {
      ...
      const statsContainer = container.querySelector(
        '.bg-black\\/60.backdrop-blur-sm.border-accent\\/20.rounded-xl.p-8'
      );
    ...
    it('renders 3 statistics skeletons', () => {
      ...
      const statNumbers = container.querySelectorAll(
        '.h-12.bg-gray-700\\/50.w-20'
      );
      const statLabels = container.querySelectorAll(
        '.h-4.bg-gray-700\\/50.w-32'
      );
  ...
  describe('Quote Grid Loading', () => {
    it('renders quote grid loading container', () => {
      ...
      const quoteGrid = container.querySelector(
    ...
    it('renders 6 quote card skeletons', () => {
      ...
      const quoteCards = container.querySelectorAll(
        '.bg-black\\/60.backdrop-blur-sm.border-accent\\/20.rounded-xl.p-6.shadow-2xl.animate-pulse'
      );
    ...
    it('renders quote card skeleton content', () => {
      ...
      const categorySkeletons = container.querySelectorAll(
        '.h-4.bg-gray-700\\/50.w-20'
      );
      const contentLineSkeletons = container.querySelectorAll(
        '.h-6.bg-gray-700\\/50'
      );
      const metadataSkeletons = container.querySelectorAll(
        '.h-4.bg-gray-700\\/50.w-24'
      );
      const actionSkeletons = container.querySelectorAll(
        '.h-8.bg-gray-700\\/50.w-16'
      );
  ...
  describe('Pagination Loading', () => {
    it('renders pagination loading section', () => {
      ...
      const paginationSection = container.querySelector(
        '.flex.justify-center.items-center.space-x-6.py-12'
      );
    ...
    it('renders 3 pagination button skeletons', () => {
      ...
      const paginationButtons = container.querySelectorAll(
        '.animate-pulse .h-12.bg-gray-700\\/50'
      );
  ...
  describe('Animation Classes', () => {
    it('applies animation classes to containers', () => {
      ...
      expect(
        container.querySelector('.slide-up.stagger-2')
      ).toBeInTheDocument();
      expect(
        container.querySelector('.slide-up.stagger-3')
      ).toBeInTheDocument();
      expect(
        container.querySelector('.slide-up.stagger-4')
      ).toBeInTheDocument();
      expect(
        container.querySelector('.slide-up.stagger-5')
      ).toBeInTheDocument();
    });
  ...
  describe('Responsive Design', () => {
    it('applies responsive classes to grid layouts', () => {
      ...
      const quotesGrid = container.querySelector(
    ...
    it('applies responsive height classes to skeletons', () => {
      ...
      const responsiveHeights = container.querySelectorAll(
        '.h-16.md\\:h-20, .h-20.md\\:h-24'
      );
  ...
  describe('Styling Consistency', () => {
    it('uses consistent card styling', () => {
      ...
      const cards = container.querySelectorAll(
        '.bg-black\\/60.backdrop-blur-sm.border.border-accent\\/20.rounded-xl'
      );
