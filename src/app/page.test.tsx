      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Daily motivation delivered with the intensity you need to push
...
describe('Home Page Components', () => {
  ...
  describe('Page Layout and Structure', () => {
    ...
    it('displays quote using QuoteCard component', () => {
      ...
      expect(
        screen.getByText(
          '"Push through the pain, that\'s where champions are made."'
        )
      ).toBeInTheDocument();
      expect(screen.getByText('MOTIVATION')).toBeInTheDocument();
  ...
  describe('Content Quality', () => {
    it('displays motivational messaging', () => {
      ...
      expect(
        screen.getByText(/Daily motivation delivered with the intensity/)
      ).toBeInTheDocument();
